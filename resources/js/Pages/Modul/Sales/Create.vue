        ...
        <div class="bg-white shadow-sm sm:rounded-lg p-6 space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              />
              <div v-if="form.errors.so_number" class="text-red-500 text-xs mt-1">{{ form.errors.so_number }}</div>
            </div>
              ...
              <tbody>
                <tr v-for="(item, index) in form.items" :key="index" class="text-sm">
                  ...
                  <td class="border p-2">
                    ...
                    <div v-if="form.errors[`product_id.${index}`]" class="text-red-500 text-xs mt-1">Wajib dipilih</div>
                  </td>
                  ...
                  <td class="border p-2">
                    <input 
                      ...
                      min="1"
                    />
                    <div v-if="form.errors[`qty.${index}`]" class="text-red-500 text-xs mt-1">Min 1</div>
                  </td>
                  ...
                  <td class="border p-2">
                    <input 
                      ...
                      min="0"
                    />
                    <div v-if="form.errors[`price.${index}`]" class="text-red-500 text-xs mt-1">Invalid</div>
                  </td>
          ...
          <div class="flex justify-end gap-3">
            ...
            >
              {{ form.processing ? 'Menyimpan...' : 'Simpan Sales Order' }}
            </button>
          </div>
