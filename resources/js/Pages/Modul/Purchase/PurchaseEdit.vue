...
const submit = () => {
    form.put(route('purchase.update', props.order.id));
};
</script>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Perbarui data permintaan penawaran (RFQ).
                    </p>
                </div>
                <Link
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input v-model="form.po_number" type="text" class="w-full rounded border-gray-300 text-sm bg-gray-100" readonly />
                                <div class="text-xs text-gray-500 mt-1">Nomor PO tidak dapat diubah.</div>
                            </div>
