...
const submit = () => form.put(route('employees.update', props.employee.id));
</script>
      ...
      <div class="mx-auto max-w-lg bg-white p-6 rounded shadow">
        <form @submit.prevent="submit" class="space-y-4">
          ...
          <div class="flex justify-between items-center">
            ...
            <button type="submit" :disabled="form.processing" class="rounded bg-blue-600 px-4 py-2 text-white">Update</button>
          </div>
        </form>
      </div>
    </div>
